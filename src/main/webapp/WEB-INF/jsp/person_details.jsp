...
<body>
	<div class="container">
		...
		<spring:url value="/home/deletePatient/${personDetails.id }"
			var="deleteURL" />
		...
		<table class="table table-striped">
			...
			<tbody modelAttribute="personDetails">
				...
				<tr>
					...
					<td>${personDetails.id_number }</td>
					<td>${personDetails.first_name }</td>
					<td>${personDetails.second_name }</td>
					<td>${personDetails.last_name }</td>
					<td>${personDetails.tel }</td>
					
					<td><spring:url
							value="/home/updatePatient/${personDetails.id }"
